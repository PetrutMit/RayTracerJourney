...
#include "../Chapter8/box.hpp"

#include "../Chapter8/rotate_y.hpp"
#include "../Chapter8/translate.hpp"

#include "../Chapter9/constant_medium.hpp"

#include "../Chapter3/bvh.hpp"
...
hittable_list final_scene() {
    ...
    auto emat = make_shared<lambertian>(make_shared<image_texture>("../Chapter10/earthmap.jpg"));
...
int main() {
    ...
    const int samples_per_pixel = 1e4;
    ...
    // Output in file
    std::ofstream ppm_image("cornell_box_fog.ppm");
