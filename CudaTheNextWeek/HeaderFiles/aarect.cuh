...
__device__ bool xy_rect::bounding_box(float t0, float t1, aabb& box) const {
...
__device__ bool xz_rect::bounding_box(float t0, float t1, aabb& box) const {
...
__device__ bool yz_rect::bounding_box(float t0, float t1, aabb& box) const {
